...
public class FragmentSherlockActivity extends FragmentActivity implements
	...
	public FragmentSherlockActivity() {
		this(ActionBarSherlock.FLAG_DELEGATE);
	}

	public FragmentSherlockActivity(int flags) {
		mSherlock = ActionBarSherlock.wrap(this, flags);
	}

	public <T extends ActionBarSherlock> FragmentSherlockActivity(int flags,
